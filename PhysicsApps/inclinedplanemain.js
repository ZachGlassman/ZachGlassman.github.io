...
function inclinedPlaneApp(){  
  ...
  function draw(){
    ...
    drawPlane(ctxbox,x0,y0,x1,y1,ycolor);
  ...
  */
  ...
  function drawPlane(ctx,x0,y0,x1,y1,color){
    var radius = 5;
    var twoPI = 2*Math.PI;
    //compute angle between lines
    var angle = Math.atan2(y1-y0,x1-x0);
